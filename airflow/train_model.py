...
def train():
    df = pd.read_csv('/home/stanislav/Hadoop/data/train.csv')
    X = df['review']
    y = df['sentiment']
    ...
    with mlflow.start_run() as first_run:
        ...
        pickle.dump(pipe['tfidf'], open("/home/stanislav/Hadoop/tfidf.pickle", "wb"))
        ...
        with open("/home/stanislav/Hadoop/run_id.txt", "w") as f:
            f.write(run_id)
        mlflow.sklearn.save_model(pipe['svc'], f'/home/stanislav/Hadoop/mlruns/1/{run_id}/artifacts/sklearn-model')
